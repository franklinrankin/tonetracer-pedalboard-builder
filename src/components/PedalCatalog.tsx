...
export function PedalCatalog() {
  ...
  return (
    <div 
      ...
      style={{ border: '4px solid var(--color-board-border)', boxShadow: '6px 6px 0px var(--color-board-shadow)' }}
    >
      {/* Header */}
      <div 
        className="p-4" 
        style={{ borderBottom: '4px solid var(--color-board-border)', backgroundColor: '#FFF9C4' }}
      >
        ...
        <div className="relative mb-4 z-10">
          ...
          <input
            ...
            className="w-full pl-10 pr-10 py-2.5 bg-white text-black placeholder:text-gray-400 font-bold focus:outline-none"
            style={{ border: '3px solid black' }}
          />
          {searchQuery && (
            <button
            ...
            {isFilterOpen && (
              ...
              >
                <button
                  ...
                  className={`w-full px-3 py-2 text-left text-sm font-bold text-black hover:bg-yellow-100 transition-colors ${
                ...
                <div className="px-3 py-1 text-[10px] text-black/60 font-bold uppercase">
                  Signal Chain Order
                </div>
                {CATEGORY_ORDER.map(cat => (
                  <button
                    ...
                    className={`w-full px-3 py-2 text-left text-sm font-bold text-black hover:bg-yellow-100 transition-colors flex items-center gap-2 ${
      ...
      >
        {filteredPedals.length === 0 ? (
          <div className="col-span-full text-center py-12">
            <div 
              className="inline-block px-4 py-2 mb-3 font-black text-2xl text-black"
