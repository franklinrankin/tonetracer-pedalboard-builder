...
export const POWER_SUPPLIES: PowerSupply[] = [
  ...
  // === BUDGET OPTIONS ===
  {
    ...
    heightIn: 1.0,
    mountable: true,
    features: ['Budget friendly', '10 outputs', 'Multiple voltages'],
  },
  {
    id: 'ps-mosky-dc-core10',
    brand: 'Mosky',
    model: 'DC-Core 10',
    totalOutputs: 10,
    totalMa: 2000,
    outputs: [
      { voltage: 9, ma: 200, count: 10 },
    ],
    isolated: false,
    msrp: 40,
    reverbPrice: 35,
    ...
    heightIn: 1.0,
    mountable: true,
    features: ['Ultra budget', 'Simple setup', 'Non-isolated'],
  },
  {
    id: 'ps-vitoos-iso4-plus',
    brand: 'Vitoos',
    model: 'ISO4 Plus',
    totalOutputs: 8,
    totalMa: 1400,
    ...
    heightIn: 1.1,
    mountable: true,
    features: ['Budget isolated', 'Multiple voltages', 'Good value'],
  },
